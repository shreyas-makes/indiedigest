...
learn to build 3 projects with Indiedigest at [24 Hour MVP](https://founderhacker.com/24-hour-mvp), or check out the [premium documentation](https://gitpaywall.com/p/ryanckulp/speedrail-docs).

**Indiedigest features**
* rich text blog CMS
...
**For detailed, step by step tutorials to using Indiedigest, get lifetime access to the [Indiedigest Docs](https://gitpaywall.com/p/ryanckulp/speedrail-docs) for a one-time fee of $49.**
...
To sync your project with the latest Indiedigest improvements:

```sh
# one time only
git remote add speedrail https://github.com/ryanckulp/speedrail.git

# when you notice Indiedigest updates on GitHub
git pull
git fetch speedrail
